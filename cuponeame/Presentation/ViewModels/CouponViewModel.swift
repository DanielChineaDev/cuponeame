        ...
        userCouponsRef.getDocuments { (querySnapshot, error) in
            ...
            if let error = error {
                ...
                if let documents = querySnapshot?.documents {
                    userCoupons = documents.compactMap { document -> CouponModel? in
                        ...
                        let newCoupon = CouponModel(id: id, title: title, category: category, description: description, short_description: shortDescription, imageName: imageName, used: used, cooldownTime: cooldownTime, cooldownExpirationDate: cooldownExpirationDate, redeemCount: redeemCount, redeemLimit: reddemLimit)
...
class CouponViewModel: ObservableObject {
    ...
    init(repository: CouponRepository) {
        ...
        self.coupon = // obtener el cupón desde el repositorio
    }
    
    func redeemCoupon() {
        coupon.redeem()
        // ... lógica adicional de presentación
    }
