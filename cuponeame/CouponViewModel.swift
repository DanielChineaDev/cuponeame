...
class CouponViewModel: ObservableObject {
            ...
            if let error = error {
                ...
                if let documents = querySnapshot?.documents {
                    userCoupons = documents.compactMap { document -> Coupon? in
                        ...
                        let newCoupon = Coupon(id:id, title: title, category: category, description: description, short_description: shortDescription, imageName: imageName, used: used)
    ...
    func redeemCoupon(couponID: String, userID: String) {
        ...
        let cooldownExpirationDate = Date().addingTimeInterval(coupon.cooldownTime)
