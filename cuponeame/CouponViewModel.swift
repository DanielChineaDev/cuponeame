...
class CouponViewModel: ObservableObject {
    ...
    func addDefaultCouponsToUser(userID: String) {
        ...
        let coupons: [Coupon] = [
            ...
            Coupon(id: "",title: "Beso", category: "Romance", description: "Un beso puede expresar más que mil palabras. Este cupón te garantiza un beso apasionado y lleno de cariño. ¡Deja que tus emociones hablen por sí solas!", short_description: "Un beso de los infinitos.", imageName: "c1", used: false, cooldownTime: 10800, cooldownExpirationDate: nil, redeemCount: 0, redeemLimit: 5),
            
            Coupon(id: "", title: "Abrazo", category: "Romance", description: "Los abrazos son como un bálsamo para el alma. Este cupón te ofrece un abrazo cálido y reconfortante que te hará sentir querido y protegido.", short_description: "Un abrazo de los que te hacen volar.", imageName: "abrazo-cupon", used: false, cooldownTime: 10800, cooldownExpirationDate: nil, redeemCount: 0, redeemLimit: 5),
            ...
            Coupon(id: "", title: "Paseo de la mano", category: "Romance", description: "Caminar juntos de la mano es una experiencia única. Este cupón te invita a disfrutar de un romántico paseo junto al mar, creando recuerdos inolvidables.", short_description: "Un paseo de la mano junto al mar.", imageName: "paseo-cupon", used: false, cooldownTime: 10800, cooldownExpirationDate: nil, redeemCount: 0, redeemLimit: 5),
            
            Coupon(id: "", title: "Tarde de sexo", category: "Intimidad", description: "Una tarde de pasión y complicidad te espera con este cupón. Disfruta de un momento íntimo de conexión y diversión. ¡La química entre nosotros será inolvidable!", short_description: "Tarde de Netflix and Chill donde quieras.", imageName: "c1", used: false, cooldownTime: 1800, cooldownExpirationDate: nil, redeemCount: 0, redeemLimit: 5),
    ...
    func addDefaultCoupons() {
        ...
        let coupons: [Coupon] = [
            Coupon(id: "", title: "Atardecer", category: "Experiencias", description: "Disfruta de un impresionante atardecer en la playa que elijas. Relájate y deja que los colores del cielo te cautiven.", short_description: "Puesta de sol en la playa que más te guste.", imageName: "c1", used: false, cooldownTime: 100, cooldownExpirationDate: nil, redeemCount: 0, redeemLimit: 5),
            
            Coupon(id: "", title: "Cena/Almuerzo", category: "Comida", description: "Saborea una deliciosa cena o almuerzo en el restaurante de tu elección. Disfruta de exquisitos platillos y un ambiente acogedor.", short_description: "Una cena/almuerzo donde quieras.", imageName: "cena-cupon", used: false, cooldownTime: 172800, cooldownExpirationDate: nil, redeemCount: 0, redeemLimit: 5),
